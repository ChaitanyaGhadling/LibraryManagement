...
CREATE TABLE `journal_volume` (
  ...
  CONSTRAINT `editor` FOREIGN KEY (`editor`) REFERENCES `person` (`pid`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `j_docid` FOREIGN KEY (`docid`) REFERENCES `document` (`docid`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `journal_volume` VALUES (25,1,2),(26,2,4),(27,3,6),(28,4,8);
