...
CREATE TABLE `journal_issue` (
  ...
  CONSTRAINT `ji_docid` FOREIGN KEY (`docid`) REFERENCES `journal_volume` (`docid`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `journal_issue` VALUES (25,'1501','Politics'),(26,'1502','Criminal'),(27,'1503','TV'),(28,'1504','Sports');
...
-- Dump completed on 2022-12-12 17:16:13
